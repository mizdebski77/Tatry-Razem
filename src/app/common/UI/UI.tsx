...
export const Button: React.FC<buttonProps> = ({ text, onClick, $background, disabled, type }) => {
    return (
        <StyledButton $background={$background} onClick={onClick} disabled={disabled} type={type}>
            {text}
        </StyledButton>
    );
};
